...
int key_right = D_KEY_RIGHTARROW;
int key_left = D_KEY_LEFTARROW;

int key_up = D_KEY_UPARROW;
int key_down = D_KEY_DOWNARROW;
int key_strafeleft = ',';
int key_straferight = '.';
int key_fire = D_KEY_RCTRL;
int key_use = ' ';
int key_strafe = D_KEY_RALT;
int key_speed = D_KEY_RSHIFT;

// 
// Heretic keyboard controls
//
 
int key_flyup = D_KEY_PGUP;
int key_flydown = D_KEY_INS;
int key_flycenter = D_KEY_HOME;

int key_lookup = D_KEY_PGDN;
int key_lookdown = D_KEY_DEL;
int key_lookcenter = D_KEY_END;

int key_invleft = '[';
int key_invright = ']';
int key_useartifact = D_KEY_ENTER;
...
int key_arti_all             = D_KEY_BACKSPACE;
int key_arti_health          = '\\';
...
int key_invpop    = 'z';
int key_invkey    = 'k';
int key_invhome   = D_KEY_HOME;
int key_invend    = D_KEY_END;
int key_invuse    = D_KEY_ENTER;
int key_invdrop   = D_KEY_BACKSPACE;
...
int key_map_north     = D_KEY_UPARROW;
int key_map_south     = D_KEY_DOWNARROW;
int key_map_east      = D_KEY_RIGHTARROW;
int key_map_west      = D_KEY_LEFTARROW;
int key_map_zoomin    = '=';
int key_map_zoomout   = '-';
int key_map_toggle    = D_KEY_TAB;
...
int key_menu_activate  = D_KEY_ESCAPE;
int key_menu_up        = D_KEY_UPARROW;
int key_menu_down      = D_KEY_DOWNARROW;
int key_menu_left      = D_KEY_LEFTARROW;
int key_menu_right     = D_KEY_RIGHTARROW;
int key_menu_back      = D_KEY_BACKSPACE;
int key_menu_forward   = D_KEY_ENTER;
int key_menu_confirm   = 'y';
int key_menu_abort     = 'n';

int key_menu_help      = D_KEY_F1;
int key_menu_save      = D_KEY_F2;
int key_menu_load      = D_KEY_F3;
int key_menu_volume    = D_KEY_F4;
int key_menu_detail    = D_KEY_F5;
int key_menu_qsave     = D_KEY_F6;
int key_menu_endgame   = D_KEY_F7;
int key_menu_messages  = D_KEY_F8;
int key_menu_qload     = D_KEY_F9;
int key_menu_quit      = D_KEY_F10;
int key_menu_gamma     = D_KEY_F11;

int key_menu_incscreen = D_KEY_EQUALS;
int key_menu_decscreen = D_KEY_MINUS;
...
void M_BindStrifeControls(void)
{
    ...
    key_jump     = 'a';
    key_lookup   = D_KEY_PGUP;
    key_lookdown = D_KEY_PGDN;
    key_invleft  = D_KEY_INS;
    key_invright = D_KEY_DEL;
